...
function Contact(props) {
  ...
  const handleSubmit = () => {
    const templateId = "template_F86dbM1F";
          ...
          <div className="contact-form-bg">
            ...
            <div className="container form-container text-left">
              ...
              <form>
                ...
                {showSuccessAlert && (
                  <div className="alert success-alert success-alert-contact">
                    <p>Email successfully sent!</p>
                  </div>
                )}

                {showSendingAlert && (
                  <div className="alert sending-alert sending-alert-contact">
                    <p>Sending Email</p>
                ...
                {showFailAlert && (
                  <div className="alert fail-alert fail-alert-contact">
                    <p>{errorMessage}</p>
                  </div>
                )}
